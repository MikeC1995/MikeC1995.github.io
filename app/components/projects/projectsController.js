...
portfolioApp.controller('projectsController', ['$scope', '$location', function ($scope, $location) {
  ...
  $scope.projects = {
    ...
    'Environment Agency': {
      ...
      description: "I was the lead front-end developer on a team commissioned to build a responsive, cross-platform web and mobile app for the Environment Agency, which presented a variety of geographic data sets in an intuitive and engaging way.<br><br>We developed an innovative ‘slider’ feature to facilitate the comparison of the data sets, alongside real-time location search and favouriting.<br><br>The app was built using web development technologies (HTML5, Less, Javascript, jQuery) and packaged for mobile with Phonegap.",
